...
type controller struct {
	...
	mksPipelineLister      appslisters.MksPipelineLister
	mksPipelineCacheSynced cache.InformerSynced
	queue                  workqueue.RateLimitingInterface
}

// Creates a new controller and returns
func newController(clientset examplecomclientset.Clientset, mksPipelineInformer appsinformers.MksPipelineInformer) *controller {
	c := &controller{
		clientset:              clientset,

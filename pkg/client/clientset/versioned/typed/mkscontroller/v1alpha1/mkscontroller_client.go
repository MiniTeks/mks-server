...
import (
	...
	"github.com/MiniTeks/mks-server/pkg/client/clientset/versioned/scheme"
...
// NewForConfigAndClient creates a new MkscontrollerV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*MkscontrollerV1alpha1Client, error) {
	...
	return &MkscontrollerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new MkscontrollerV1alpha1Client for the given config and
...
func New(c rest.Interface) *MkscontrollerV1alpha1Client {
	return &MkscontrollerV1alpha1Client{c}
}
